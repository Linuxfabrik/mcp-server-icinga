...
[Report a vulnerability](https://github.com/Linuxfabrik/mcp-server-icinga/security/advisories/new)
...
Advisories](https://github.com/Linuxfabrik/mcp-server-icinga/security/advisories).
